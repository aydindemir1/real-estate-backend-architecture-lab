...
- Mevcut REST baseline korunacak
- Internal service-to-service çağrılar için gRPC eklenecek
- Flexible query use-case'leri için GraphQL eklenecek
- Deadline, unavailable ve error path'ler test edilecek
